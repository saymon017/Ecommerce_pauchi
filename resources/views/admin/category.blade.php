                            ...
                            @foreach ($categories as $category)
                                <div class="form-group">
                                    <div class="input-group">
                                        <input style="color: #fff" type="text" class="form-control" value="{{$category->category_name}}">
                                        <div class="input-group-append">
                                            <a href="{{url('delete_category',$category->id)}}" class="btn btn-sm btn-danger" type="Delete">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
