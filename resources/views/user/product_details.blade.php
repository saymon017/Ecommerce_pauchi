...
<head>
    <base href="/public">
    <meta charset="utf-8">
    <title>CyberMart | Detalles del producto</title>
...
<body>
    ...
    <main class="main">
        @if(session()->has('message'))
            ...
            <strong>¡Fracasada!</strong> {{session()->get('message')}}
                ...
                <div class="row">
                                    ...
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            <div class="pro-details-brand">
                                                <span> Categoría: <a href="#">{{$product->category}}</a></span>
                                            </div>
                                            <div class="product-rate-cover text-end">
                                                ...
                                                <span class="font-small ml-5 text-muted"> (25 comentarios)</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product_sort_info font-xs mb-30">
                                            <ul>
                                                ...
                                                <li><i class="fi-rs-credit-card mr-5"></i> Pago contra reembolso disponible</li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="product-extra-link2">
                                                    @if($product->quantity <1)
                                                        <p style="font-size: 12px;">
                                                            Disponibilidad:<span class="in-stock text-danger ml-5">{{$product->quantity}} Artículos en stock</span>
                                                        </p>
                                                        <button style="opacity: 0.5;cursor: not-allowed;" disabled type="submit" class="button button-add-to-cart">Añadir al carrito</button>
                                                    @else
                                                        <button type="submit" class="button button-add-to-cart">Añadir al carrito</button>
                                                    @endif
                                                </div>
                                            </form>
                                        </div>
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            <li>ADisponibilidad:<span class="in-stock text-success ml-5">{{$product->quantity}} Artículos en stock</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                            ...
                            <section id="product-details">
                                <div class="tab-style3">
                                    <ul class="nav nav-tabs text-uppercase">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="Additional-info-tab" data-bs-toggle="tab" href="#Additional-info">Detalles del producto</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="tab-pane fade show active" id="Additional-info">
                                            <table class="font-md">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Memoria de la tarjeta gráfica</th>
                                                        <td>
                                                            <p>{{$product->graphics_card_memory}}</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Generación de procesadores</th>
                                                        <td>
                                                            <p>{{$product->processor_generation}} Generación</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                <li><span style="font-weight:bold">Procesador: </span> {{$product->processor_type}} {{$product->processor}}</li>
                                <li><span style="font-weight:bold">Sistema operativo: </span>{{$product->operating_system}}</li>
                                <li><span style="font-weight:bold">RAM: </span>{{$product->ram}}</li>
                                <li><span style="font-weight:bold">Capacidad de SSD: </span>{{$product->ssd_capacity}}</li>
                            </ul>
                        </div>
                    </div>
                </div>
