...
<div class="container">
    <h3 class="text-center m-5">Pago con tarjeta</h3>
    <div class="row">
                    ...
                    <form
                        ...
                        <div class='form-row row'>
                            <div class='col-md-12 error form-group hide'>
                                <div class='alert-danger alert'>Por favor, corrija los errores e intente
                                    otra vez.</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pagar ahora (${{$totalPrice}})</button>
                            </div>
                        </div>
